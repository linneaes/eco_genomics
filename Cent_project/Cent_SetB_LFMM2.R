...
meta <- read.csv("/gpfs1/cl/pbio3990/GroupProjects/Cent_climadapt/metaB.csv", row.names = "X")
dim(meta)
...
vcflfmm <- read.lfmm("/users/l/e/lericsso/vcf_final.filtered_setB.lfmm_imputed.lfmm")
...
dat.imp = read.lfmm("/users/l/e/lericsso/vcf_final.filtered_setB.lfmm_imputed.lfmm")
