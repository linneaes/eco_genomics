...
meta <- read.csv("/gpfs1/cl/pbio3990/GroupProjects/Cent_climadapt/metaC.csv", row.names = "X")
dim(meta)
...
dat.imp = read.lfmm("/users/l/e/lericsso/vcf_final.filtered_setC.lfmm_imputed.lfmm")
