...
project = NULL
project = snmf("~/projects/eco_genomics/Cent_project/vcf_final.filtered_setA.lfmm",
               K = 1:10,
               entropy = TRUE,
               repetitions = 10,
               project = "new")
...
project.missing = snmf("~/projects/eco_genomics/Cent_project/vcf_final.filtered_setA.lfmm", K = 5,
...
LEA::impute(project.missing, "~/projects/eco_genomics/Cent_project/vcf_final.filtered_setA.lfmm",
...
dat.imp = read.lfmm("~/projects/eco_genomics/Cent_project/vcf_final.filtered_setA.lfmm_imputed.lfmm")
